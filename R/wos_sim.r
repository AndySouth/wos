...
input <- resistance::setInputSensiScenarios( nScenarios = nrow(dfsim), P_2=c(0,0) )
...
listOut <- resistance::runModel2(input, produce.plots = FALSE)

#
resistPoints <- resistance::findResistancePoints(listOut, locus=1, criticalPoints = 0.5)
#transpose
